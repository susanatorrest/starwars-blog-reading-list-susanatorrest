	...
	return (
		<nav className="nave navbar mb-3 mt-3 justify-content-evenly">
			...
			<div className="dropdown">
    			<button className="btn btn-outline-primary border-3 dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
        		Favorites
        		<span className="ms-2 border border-primary rounded-pill p-1">
